...
# Based on above, just need quantile normalization
...
#Gene_Symbol <- gset@featureData@data[["Gene.symbol"]] # Get the gene symbols to replace probeset IDs with
# Save the data
# write.table(GSE4302_expr_matrix, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE4302/GSE4302_expr_matrix.txt")
# write.table(GSE4302_sstat_data, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE4302/GSE4302_sstat_data.txt")
...
GSE4302_CSvsNS_GEO2R_limma_all <- tT %>%
...
# Filter for FDR < 0.05
GSE4302_CSvsNS_GEO2R_limma_sig <- GSE4302_CSvsNS_GEO2R_limma_all %>%
  filter(adj.P.Val <= 0.05) # Remove FDR > 0.05 genes

# Checking for ties
ties <- GSE4302_CSvsNS_GEO2R_limma_sig %>%
  group_by(Gene.symbol) %>%
  filter(n() > 1) %>%
  ungroup()
print(ties)
# Only tie is NQO1. Both probes have s suffix. I will arbitrarily choose the one of magnitude 1.56 rather than 1.50
GSE4302_CSvsNS_GEO2R_limma_sig <- GSE4302_CSvsNS_GEO2R_limma_sig %>%
  filter(ID != "201468_s_at") 

head(GSE4302_CSvsNS_GEO2R_limma_sig)
nrow(GSE4302_CSvsNS_GEO2R_limma_sig) # 3050 is a heckuva lot of genes for a small dataset...

# Save the output (relative path was giving me issues)
#write.table(GSE4302_CSvsNS_GEO2R_limma_sig, "/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE4302/GSE4302_CSvsNS_GEO2R_limma_sig.txt", 
...
hist(GSE4302_CSvsNS_GEO2R_limma_all$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
     ylab = "Number of genes", main = "P-adj value distribution")
# Definitely skewed towards significant genes
hist(GSE4302_CSvsNS_GEO2R_limma_sig$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
     ylab = "Number of genes", main = "P-adj value distribution")
...
DEGs <- GSE4302_CSvsNS_GEO2R_limma_all
DEGs_significant <- GSE4302_CSvsNS_GEO2R_limma_sig

GSE4302_CSvsNS_GEO2R_limma_volcano <- ggplot(DEGs, aes(x = logFC, y = -log10(adj.P.Val))) +
...
GSE4302_CSvsNS_GEO2R_limma_volcano
```
...
# Separation doesn't look perfect here, but definitely a light split.
...
# #Gene_Symbol <- gset@featureData@data[["Gene.symbol"]] # Get the gene symbols to replace probeset IDs with
# # Save the data
# write.table(GSE7895_expr_matrix, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE7895/GSE7895_expr_matrix.txt")
# write.table(GSE7895_sstat_data, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE7895/GSE7895_sstat_data.txt")
```
...
GSE7895_CSvsNS_GEO2R_limma_all <- tT %>%
  filter(Gene.symbol != "") %>% # Remove blank gene symbols
#  filter(adj.P.Val <= 0.05) %>% # Remove FDR > 0.05 genes
  group_by(Gene.symbol) %>%
  slice_min(adj.P.Val, with_ties = TRUE) %>% 
  # For probesets mapping to same gene, keep one with lowest FDR. Keep ties for now to check later.
  ungroup()
head(GSE7895_CSvsNS_GEO2R_limma_all)

GSE7895_CSvsNS_GEO2R_limma_sig <- GSE7895_CSvsNS_GEO2R_limma_all %>%
  filter(adj.P.Val <= 0.05) # Remove FDR > 0.05 genes
head(GSE7895_CSvsNS_GEO2R_limma_sig)

# Checking for ties
ties <- GSE7895_CSvsNS_GEO2R_limma_sig %>%
  group_by(Gene.symbol) %>%
  filter(n() > 1) %>%
  ungroup()
print(ties)
...
GSE7895_CSvsNS_GEO2R_limma_sig <- GSE7895_CSvsNS_GEO2R_limma_sig %>%
...
# Save this output
# write.table(GSE7895_CSvsNS_GEO2R_limma_sig, file='/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE7895/GSE7895_CS_NS_GEO2R_limma_sig.txt', row.names=FALSE, sep="\t")
...
# Build histogram of P-values for all genes. Normal test
# assumption is that most genes are not differentially expressed.
hist(GSE7895_CSvsNS_GEO2R_limma_all$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
     ylab = "Number of genes", main = "P-adj value distribution")
...
# Renaming generically for convenience
DEGs <- GSE7895_CSvsNS_GEO2R_limma_all
DEGs_significant <- GSE7895_CSvsNS_GEO2R_limma_sig

GSE7895_CSvsNS_GEO2R_limma_volcano <- ggplot(DEGs, aes(x = logFC, y = -log10(adj.P.Val))) +
  geom_point(aes(color = ifelse(adj.P.Val < 0.05, "red", "black")), alpha = 0.6, show.legend = FALSE) +
  stat_dens2d_labels(data = DEGs_significant, 
                     aes(label = Gene.symbol), geom = "text_repel", 
                     size = 2, 
  ...
  labs(title = "DEGs in GSE7895 Current vs. Never Smokers",
       ...
       y = "-log10(FDR)",
       caption = paste0("significant DEGs: n = ", nrow(DEGs_significant)))
GSE7895_CSvsNS_GEO2R_limma_volcano
```
...
# #Gene_Symbol <- gset@featureData@data[["Gene.symbol"]] # Get the gene symbols to replace probeset IDs with
# # Save the data
# write.table(GSE14633_expr_matrix, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE14633/GSE14633_expr_matrix.txt")
# write.table(GSE14633_sstat_data, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE14633/GSE14633_sstat_data.txt")
...
GSE14633_CSvsNS_GEO2R_limma_all <- tT %>%
...
GSE14633_CSvsNS_GEO2R_limma_sig <- GSE14633_CSvsNS_GEO2R_limma_all %>%
  filter(adj.P.Val <= 0.05)

# Checking for ties
ties <- GSE14633_CSvsNS_GEO2R_limma_sig %>%
  group_by(gene_assignment) %>%
  filter(n() > 1) %>%
  ungroup()
print(ties) 
...
head(GSE14633_CSvsNS_GEO2R_limma_sig)

## Save table

#write.table(GSE14633_CSvsNS_GEO2R_limma_sig, file='/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE14633/GSE14633_CS_NS_GEO2R_limma_sig.txt', row.names=FALSE, sep="\t")
...
# Build histogram of P-values for all genes. Normal test
# assumption is that most genes are not differentially expressed.
hist(GSE14633_CSvsNS_GEO2R_limma_all$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
     ylab = "Number of genes", main = "P-adj value distribution")
...
# Renaming generically for convenience
DEGs <- GSE14633_CSvsNS_GEO2R_limma_all
DEGs_significant <- GSE14633_CSvsNS_GEO2R_limma_sig

GSE14633_CSvsNS_GEO2R_limma_volcano <- ggplot(DEGs, aes(x = logFC, y = -log10(adj.P.Val))) +
  geom_point(aes(color = ifelse(adj.P.Val < 0.05, "red", "black")), alpha = 0.6, show.legend = FALSE) +
  stat_dens2d_labels(data = DEGs_significant, 
  ...
  labs(title = "DEGs in GSE14633 Current vs. Never Smokers",
       ...
       y = "-log10(FDR)",
       caption = paste0("significant DEGs: n = ", nrow(DEGs_significant)))
GSE14633_CSvsNS_GEO2R_limma_volcano
```
...
min(exprs(gset)) # 0.2893563 
max(exprs(gset)) # 13.91007
```
...
# #Gene_Symbol <- gset@featureData@data[["Gene.symbol"]] # Get the gene symbols to replace probeset IDs with
# # Save the data
# write.table(GSE19027_expr_matrix, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE19027/GSE19027_expr_matrix.txt")
# write.table(GSE19027_sstat_data, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE19027/GSE19027_sstat_data.txt")
```
...
# Now I want to filter unlabelled genes, duplicate genes, and adj.P.Val < 0.05
GSE19027_CSvsNS_GEO2R_limma_all <- tT %>%
  filter(Gene.symbol != "") %>% # Remove blank gene symbols
#  filter(adj.P.Val <= 0.05) %>% # Remove FDR > 0.05 genes
  group_by(Gene.symbol) %>%
  slice_min(adj.P.Val, with_ties = TRUE) %>% 
...
# filter to FDR < 0.05
GSE19027_CSvsNS_GEO2R_limma_sig <- GSE19027_CSvsNS_GEO2R_limma_all %>%
  filter(adj.P.Val <= 0.05) # Remove FDR > 0.05 genes

# Checking for ties
ties <- GSE19027_CSvsNS_GEO2R_limma_sig %>%
  group_by(Gene.symbol) %>%
  filter(n() > 1) %>%
  ungroup()
print(ties)
...
GSE19027_CSvsNS_GEO2R_limma_sig <- GSE19027_CSvsNS_GEO2R_limma_sig %>%
  filter(ID != '216320_x_at')

head(GSE19027_CSvsNS_GEO2R_limma_sig)
nrow(GSE19027_CSvsNS_GEO2R_limma_sig)

# Save output
#write.table(GSE19027_CSvsNS_GEO2R_limma_sig, file='/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE19027/GSE19027_CS_NS_GEO2R_limma_sig.txt', row.names=FALSE, sep="\t")
...
hist(GSE19027_CSvsNS_GEO2R_limma_all$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
...
# Renaming generically for convenience
DEGs <- GSE19027_CSvsNS_GEO2R_limma_all
DEGs_significant <- GSE19027_CSvsNS_GEO2R_limma_sig

GSE19027_CSvsNS_GEO2R_limma_volcano <- ggplot(DEGs, aes(x = logFC, y = -log10(adj.P.Val))) +
  geom_point(aes(color = ifelse(adj.P.Val < 0.05, "red", "black")), alpha = 0.6, show.legend = FALSE) +
  stat_dens2d_labels(data = DEGs_significant, 
                     aes(label = Gene.symbol), geom = "text_repel", 
                     size = 2, 
  ...
  labs(title = "DEGs in GSE19027 Current vs. Never Smokers",
       ...
       y = "-log10(FDR)",
       caption = paste0("significant DEGs: n = ", nrow(DEGs_significant)))
GSE19027_CSvsNS_GEO2R_limma_volcano
```
...
hist(as.matrix(exprs(gset))) # much better
boxplot(exprs(gset)) # Look identical
...
# #Gene_Symbol <- gset@featureData@data[["Gene.symbol"]] # Get the gene symbols to replace probeset IDs with
# # Save the data
# write.table(GSE20257_expr_matrix, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE20257/GSE20257_expr_matrix.txt")
# write.table(GSE20257_sstat_data, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE20257/GSE20257_sstat_data.txt")
...
GSE20257_GEO2R_limma_sig <- GSE20257_GEO2R_limma_all %>%
  filter(adj.P.Val <= 0.05) # Remove FDR > 0.05 genes

# Checking for ties
ties <- GSE20257_GEO2R_limma_sig %>%
  group_by(Gene.symbol) %>%
  filter(n() > 1) %>%
  ungroup()
print(ties) 
...
GSE20257_GEO2R_limma_sig <- GSE20257_GEO2R_limma_sig %>%
  filter(ID != c('204151_x_at', '230412_at'))

head(GSE20257_GEO2R_limma_sig)
nrow(GSE20257_GEO2R_limma_sig)

# Save output
#write.table(GSE20257_GEO2R_limma_sig, "/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE20257/GSE20257_GEO2R_limma_sig.txt", sep = '\t', col.names = TRUE, row.names = FALSE)
```
...
hist(GSE20257_GEO2R_limma_all$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
     ylab = "Number of genes", main = "P-adj value distribution")
...
# Renaming generically for convenience
DEGs <- GSE20257_GEO2R_limma_all
DEGs_significant <- GSE20257_GEO2R_limma_sig

GSE20257_CSvsNS_GEO2R_limma_volcano <- ggplot(DEGs, aes(x = logFC, y = -log10(adj.P.Val))) +
  geom_point(aes(color = ifelse(adj.P.Val < 0.05, "red", "black")), alpha = 0.6, show.legend = FALSE) +
  stat_dens2d_labels(data = DEGs_significant, 
                     aes(label = Gene.symbol), geom = "text_repel", 
                     size = 2, 
  ...
  labs(title = "DEGs in GSE20257 Current vs. Never Smokers",
       ...
       y = "-log10(FDR)",
       caption = paste0("significant DEGs: n = ", nrow(DEGs_significant)))
GSE20257_CSvsNS_GEO2R_limma_volcano
```
...
GSE63127_expr_matrix <- as.data.frame(exprs(gset))  # Extract the expression matrix
GSE63127_sstat_data <- gset$group   # Extract the smoking status labels
Gene_Symbol <- gset@featureData@data[["Gene.symbol"]] # Get the gene symbols to replace probeset IDs with
GSE63127_expr_matrix <- cbind(Gene_Symbol, GSE63127_expr_matrix) # Add a gene symbol column to the expression matrix

# Save the data
write.table(GSE63127_expr_matrix, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE63127/GSE63127_expr_matrix.txt")
write.table(GSE63127_sstat_data, "../../../Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE63127/GSE63127_sstat_data.txt")
```
...
#write.table(GSE63127_CSvsNS_GEO2R_limma_sig, "/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE63127/GSE63127_CSvsNS_GEO2R_limma_sig.txt", sep = '\t', col.names = TRUE, row.names = FALSE)
...
hist(GSE63127_CSvsNS_GEO2R_limma_all$adj.P.Val, col = "grey", border = "white", xlab = "P-adj",
     ylab = "Number of genes", main = "P-adj value distribution")
...
# Renaming generically for convenience
DEGs <- GSE63127_CSvsNS_GEO2R_limma_all
DEGs_significant <- GSE63127_CSvsNS_GEO2R_limma_sig

GSE63127_CSvsNS_GEO2R_limma_volcano <- ggplot(DEGs, aes(x = logFC, y = -log10(adj.P.Val))) +
  geom_point(aes(color = ifelse(adj.P.Val < 0.05, "red", "black")), alpha = 0.6, show.legend = FALSE) +
  stat_dens2d_labels(data = DEGs_significant, 
                     aes(label = Gene.symbol), geom = "text_repel", 
                     size = 2, 
  ...
  labs(title = "DEGs in GSE63127 Current vs. Never Smokers",
       ...
       y = "-log10(FDR)",
       caption = paste0("significant DEGs: n = ", nrow(DEGs_significant)))
GSE63127_CSvsNS_GEO2R_limma_volcano
```

# Making a combined table to rank genes of interest and compare studies

## Read in tables
### Note: I should redo this without reading in all the tables, should just use the internal tables. It has the same effect but it's just more satisfyingly self-contained that way
```{r}
## Read in the tables
GSE4302_CS_NS_GEO2R_limma_sig <- read.table("/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE4302/GSE4302_CS_NS_GEO2R_limma_sig.txt")
# For some reason column names are giving me grief, so I have to set them
colnames(GSE4302_CS_NS_GEO2R_limma_sig) <- GSE4302_CS_NS_GEO2R_limma_sig[1,]
GSE4302_CS_NS_GEO2R_limma_sig <- GSE4302_CS_NS_GEO2R_limma_sig[-1,]

GSE7895_CS_NS_GEO2R_limma_sig <- read.table("/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE7895/GSE7895_CS_NS_GEO2R_limma_sig.txt")
# For some reason column names are giving me grief, so I have to set them
colnames(GSE7895_CS_NS_GEO2R_limma_sig) <- GSE7895_CS_NS_GEO2R_limma_sig[1,]
GSE7895_CS_NS_GEO2R_limma_sig <- GSE7895_CS_NS_GEO2R_limma_sig[-1,]

GSE14633_CS_NS_GEO2R_limma_sig <- read.table("/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE14633/GSE14633_CS_NS_GEO2R_limma_sig.txt")
# For some reason column names are giving me grief, so I have to set them
colnames(GSE14633_CS_NS_GEO2R_limma_sig) <- GSE14633_CS_NS_GEO2R_limma_sig[1,]
GSE14633_CS_NS_GEO2R_limma_sig <- GSE14633_CS_NS_GEO2R_limma_sig[-1,]

GSE19027_CS_NS_GEO2R_limma_sig <- read.table("/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE19027/GSE19027_CS_NS_GEO2R_limma_sig.txt")
# For some reason column names are giving me grief, so I have to set them
...
GSE20257_CS_NS_GEO2R_limma_sig <- read.table("/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE20257/GSE20257_CS_NS_GEO2R_limma_sig.txt")
# For some reason column names are giving me grief, so I have to set them
...
GSE63127_CS_NS_GEO2R_limma_sig <- read.table("/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/GSE63127/GSE63127_CSvsNS_GEO2R_limma_sig.txt")
# For some reason column names are giving me grief, so I have to set them
...
library(dplyr)
CS_NS_gene_rank_input <- as.data.frame(rbind(cbind("GSE19027", GSE19027_CS_NS_GEO2R_limma_sig$Gene.symbol, GSE19027_CS_NS_GEO2R_limma_sig$logFC, GSE19027_CS_NS_GEO2R_limma_sig$adj.P.Val ), cbind("GSE14633", GSE14633_CS_NS_GEO2R_limma_sig$gene_assignment, GSE19027_CS_NS_GEO2R_limma_sig$logFC, GSE19027_CS_NS_GEO2R_limma_sig$adj.P.Val), cbind("GSE20257", GSE20257_CS_NS_GEO2R_limma_sig$Gene.symbol, GSE20257_CS_NS_GEO2R_limma_sig$logFC, GSE20257_CS_NS_GEO2R_limma_sig$adj.P.Val), cbind("GSE4302", GSE4302_CS_NS_GEO2R_limma_sig$Gene.symbol, GSE4302_CS_NS_GEO2R_limma_sig$logFC, GSE4302_CS_NS_GEO2R_limma_sig$adj.P.Val), cbind("GSE63127",GSE63127_CS_NS_GEO2R_limma_sig$Gene.symbol, GSE63127_CS_NS_GEO2R_limma_sig$logFC, GSE63127_CS_NS_GEO2R_limma_sig$adj.P.Val), cbind("GSE7895", GSE7895_CS_NS_GEO2R_limma_sig$Gene.symbol, GSE7895_CS_NS_GEO2R_limma_sig$logFC, GSE7895_CS_NS_GEO2R_limma_sig$adj.P.Val)))
...
# Save the output
#write.table(CS_NS_ranked_genes, "/Users/liambrockley/Desktop/Former_Smokers_Project/Former_Smokers_Aim_1/2_Output/GEO2R_limma_analysis/CS_NS_GEO2R_limma_ranked_genes.txt", sep = '\t', row.names = FALSE, col.names = TRUE)

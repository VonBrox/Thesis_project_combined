---
title: "Tumor airway comparisons (LUSC) combined script"
...
# 2. Differential expression analysis of TCGA-LUSC tumor vs normal tissue (T-E)
...
# Save output
write.table(TCGA_LUSC_limma_DEG, "../2_Outputs/4_Tumor_DEGs/TCGA_LUSC_limma_DEG_20250221.txt", sep = '\t')
...
### Saving output
#write.table(TCGA_LUSC_limma_DMG, "../2_Outputs/5_Tumor_DMGs/TCGA_LUSC_limma_DMG_20250131.txt", sep = '\t')

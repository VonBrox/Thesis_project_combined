...
- For A1 I use log2 normalization, batch correction for submission date, and correction for unknown source of variation (using ComBat)
...
#write.table(GSE63127_CS_NS_limma, "../2_Outputs/GSE63127_CS_NS_limma_20241204.txt", sep = '\t')
...
The smallest group (tumor or normal) has 57 members, so this filters out any genes that cannot reach a sum of 10 counts using 57 samples.

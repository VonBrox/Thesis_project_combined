...
Notes: 
- 2025/02/05: For this version of the pipeline, I am using limma for A1, limma for T-E, and limma for T-M, which uses the cbioportal-derived data. I will also eliminate never smokers from TE and TM. [Later I may also want to remove current smokers when I do the comparisons for "persistent linked" genes, not sure.]
...
# Save output
#write.table(TCGA_LUAD_limma_DEG, "../2_Outputs/4_Tumor_DEGs/TCGA_LUAD_limma_DEG_CSFS_20250129.txt", sep = '\t')

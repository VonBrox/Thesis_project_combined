...
# T-E
TCGA_LUAD_limma_DEG       <- read.table("../2_Outputs/4_Tumor_DEGs/TCGA_LUAD_limma_DEG_CSFSNS_20250221.txt")
...
nrow(TCGA_LUAD_limma_DEG[TCGA_LUAD_limma_DEG$FDR<FDR_cutoff_TE
                              & abs(TCGA_LUAD_limma_DEG$log2FC)>log2FC_cutoff_TE,])

hist(TCGA_LUAD_limma_DEG[TCGA_LUAD_limma_DEG$FDR<FDR_cutoff_TE
                              & abs(TCGA_LUAD_limma_DEG$log2FC)>log2FC_cutoff_TE,]$log2FC, breaks = 100)

hist(log10(TCGA_LUAD_limma_DEG[TCGA_LUAD_limma_DEG$FDR<FDR_cutoff_TE
                              & abs(TCGA_LUAD_limma_DEG$log2FC)>log2FC_cutoff_TE,]$FDR), breaks = 100)
...
TCGA_LUAD_limma_DEG_cutoff <- TCGA_LUAD_limma_DEG %>%
...
A1_TE_merged_DEGs <- GSE63127_CS_NS_limma_cutoff %>%
  inner_join(., TCGA_LUAD_limma_DEG_cutoff, by = "Gene") %>%
...
linked_gene_result <- function(GSE63127_CS_NS_limma, TCGA_LUAD_limma_DEG, TCGA_LUAD_limma_DMG, 
...
for (row in 1:nrow(cutoff_combinations)){
  ...
  TE_DEGs_curr <- TCGA_LUAD_limma_DEG[TCGA_LUAD_limma_DEG$FDR<cutoff_combinations$FDR_TE[row]
                              & abs(TCGA_LUAD_limma_DEG$log2FC)>cutoff_combinations$log2FC_TE[row],]

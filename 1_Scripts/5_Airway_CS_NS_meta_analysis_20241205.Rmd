...
2024/12/05: As an experiment I think I want to use the 29 "linked genes" obtained with stringent cutoffs and the 27 "persistent linked genes" arrived at with lenient cutoffs.
...
linked_genes <- read.table('../2_Outputs/6_Linked_genes/A1_TE_TM_linked_genes_0.01_0.1_0.01_0.6_0.01_0.1_20241205.txt', header = TRUE)

# Read in the persistent linked genes
persistent_linked_genes <- read.table('../2_Outputs/6_Linked_genes/A1_TE_TM_A2_persistent_linked_genes_0.05_0_0.05_0_0.05_0_20241205.txt', header = TRUE)

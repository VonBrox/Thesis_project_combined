...
```{r}
GSE63127_CS_NS_GEO2R_limma <- read.table("../2_Outputs/1_Airway_DEGs/GSE63127_CS_NS_limma_20241204.txt", header = TRUE)
...
nrow(GSE63127_CS_NS_GEO2R_limma[GSE63127_CS_NS_GEO2R_limma$adj.P.Val<FDR_cutoff_A1
                                    & abs(GSE63127_CS_NS_GEO2R_limma$logFC)>log2FC_cutoff_A1,])

hist(GSE63127_CS_NS_GEO2R_limma[GSE63127_CS_NS_GEO2R_limma$adj.P.Val<FDR_cutoff_A1
                                    & abs(GSE63127_CS_NS_GEO2R_limma$logFC)>log2FC_cutoff_A1,]$logFC, breaks = 100)
...
GSE63127_CS_NS_GEO2R_limma_cutoff <- GSE63127_CS_NS_GEO2R_limma %>%
...
A1_TE_merged_DEGs <- GSE63127_CS_NS_GEO2R_limma_cutoff %>%

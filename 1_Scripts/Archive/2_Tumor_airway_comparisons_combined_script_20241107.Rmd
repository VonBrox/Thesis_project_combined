...
# Add gene names to the DEGs list
...
# should convert to M values!

## 3.4 Differential analysis and filtering to FDR < 0.05
```{r}
...
nrow(DMeth_LUAD_T_NM_hm450_sig) # 9925 (2024/11/08)
...
```{r}
# Change date suffix as appropriate if modifications are made
#write.table(DMeth_LUAD_T_NM_hm450_sig, "../2_Outputs/DMeth_LUAD_T_NM_hm450_sig_20241108.txt", sep = '\t')
```

## 3.6 Visualizing DMGs as volcano plot
```{r}

...
DGE_LUAD_T_NM_DSeq2_sig <- res_table_sig
DGE_LUAD_T_NM_DSeq2_sig_cutoff1 <- res_table_sig_cutoff1

```


## 2.3.5 Visualization of DEGs from DSEq2 method (volcano plot)
```{r, fig.width=10, fig.height=6}
...
DESeq2_list <- DGE_LUAD_T_NM_DSeq2_sig$gene

...
2024/11/13: I am electing to use the log2FC values from the airway dataset (A1) for pathway analysis. I reason that we are more interested in the dysregulated pathways in the airways than the tumors even if we are looking at the genes linked to all 3 modalities.
```{r}

A1_TE_TM_linked_genes_nocutoffs_20241112 <- read.table('../2_Outputs/A1_TE_TM_linked_genes_nocutoffs_20241112.txt', header = TRUE)

# The log2FC of the airway dataset is what I am choosing for pathway analysis
linked_gene_list_A1_sorted <- A1_TE_TM_linked_genes_nocutoffs_20241112$log2FC_A1

# name the vector
names(linked_gene_list_A1_sorted) <- A1_TE_TM_linked_genes_nocutoffs_20241112$Gene
...
# ggsave("../2_Output/RMA_output/plots/GSEA_plots/linked_gene_list_A1_sorted/linked_gene_list_A1_sorted_GO_dotplot.png", linked_gene_list_A1_sorted_dotplot, width = 7, height = 12)
...
linked_gene_list_A1_sorted_emapplot <- enrichplot::emapplot(term_sim_matrix, showCategory = 10)

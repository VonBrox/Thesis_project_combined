...
A1_TE_TM_linked_genes <- read.table('../2_Outputs/6_Linked_genes/A1_TE_TM_linked_genes_20241204.txt', header = TRUE)
...
## OK this is not a good list to use for this -- too few genes...
